...
The original `packages/ui/` paths below describe the source project only.
Resolve the current repository layout, aliases, component registry, package
manager, and design tokens before applying an example.
