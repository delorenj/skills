...
description: >-
  ...
  PTYs, Playwright, or Computer Use when the task touches Orca-managed state; for
  a web page outside Orca's embedded browser, use kapture, and Computer Use for
  webviews or other desktop UI.
---
