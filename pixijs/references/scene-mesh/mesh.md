...
When a shader is provided, `texture` is optional; the shader decides what to sample. Custom shaders bypass batching entirely. See the `custom-rendering` skill for full shader authoring detail.
