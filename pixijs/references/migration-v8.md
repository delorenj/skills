...
**Related references:** `application` (async init), `scene-graphics` (new fill/stroke API), `custom-rendering` (shader rework), `scene-text` (Text constructor changes), `performance` (destroy patterns).
