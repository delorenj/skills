...
**Related references:** `scene-container` (destroy options), `scene-core-concepts` (render groups, layers, culling), `scene-text` (BitmapText for dynamic content), `assets` (atlasing), `custom-rendering` (custom batchers).
