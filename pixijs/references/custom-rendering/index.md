...
**Related references:** `filters` (built-in filters), `scene-mesh` (custom geometry), `performance` (batch optimization), `migration-v8` (shader API migration from v7).
...
See [uniform-types.md](uniform-types.md) for the complete table of supported types, their WGSL/GLSL equivalents, and value formats.
