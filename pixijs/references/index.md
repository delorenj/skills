# PixiJS Topics: Full Index

Detailed routing for the PixiJS v8 references. Each entry lists the topic's full description, trigger keywords, and the file to load. For a scannable short-form table, see the parent [`SKILL.md`](../SKILL.md).
...
**Load:** [application/index.md](application/index.md)
...
**Load:** [core-concepts/index.md](core-concepts/index.md)
...
**Load:** [environments.md](environments.md)
...
**Load:** [migration-v8.md](migration-v8.md)

### scene-core-concepts
The PixiJS v8 scene graph as a whole: how containers, leaves, transforms, and render order fit together. Covers leaf vs container distinction, local/world coordinates, culling, render groups, sortable children, masking, `RenderLayer`, and which leaf reference covers which display object.
...
**Load:** [scene-core-concepts/index.md](scene-core-concepts/index.md)
...
**Load:** [scene-container.md](scene-container.md)
...
**Load:** [scene-dom-container.md](scene-dom-container.md)
...
**Load:** [scene-gif.md](scene-gif.md)
...
**Load:** [scene-graphics.md](scene-graphics.md)
...
**Load:** [scene-mesh/index.md](scene-mesh/index.md)

### scene-particle-container
...
**Load:** [scene-particle-container.md](scene-particle-container.md)
...
**Load:** [scene-sprite/index.md](scene-sprite/index.md)
...
**Load:** [scene-text/index.md](scene-text/index.md)
...
**Load:** [assets/index.md](assets/index.md)
...
**Load:** [accessibility.md](accessibility.md)
...
**Load:** [blend-modes.md](blend-modes.md)
...
**Load:** [custom-rendering/index.md](custom-rendering/index.md)
...
**Load:** [performance.md](performance.md)
