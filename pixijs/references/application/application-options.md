...
See `ticker` for the ticker API itself.
...
| Option                     | Type                                                     | Default     | Description                                                                                                                      |
| -------------------------- | -------------------------------------------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `eventMode`                | `'none' \| 'passive' \| 'auto' \| 'static' \| 'dynamic'` | `'passive'` | Default interaction mode for every container. See `events`.                                                               |
...
See `accessibility` for the full accessibility API.
