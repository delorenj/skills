# Imported evaluation methods

Use only the evaluation steps requested. Examples do not mandate subagents,
external writes, or a full optimization loop. Resolve bundled file paths from
the skill directory, not this reference directory.
